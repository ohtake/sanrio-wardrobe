            ...
            {DataFile.all.map(df => (
              <TableRow style={rowStyle}>
                <TableRowColumn style={cellStyle}>
                  <RouterLink to={`/chara/${df.name}`} data-ga-on="click" data-ga-event-category="chara" data-ga-event-action="statCount" data-ga-event-label={df.name}>
        ...
        <Table selectable={false}>
          ...
          <TableBody displayRowCheckbox={false} stripedRows>
            {DataFile.all.map(df => (
              <TableRow style={rowStyle}>
                <TableRowColumn style={cellStyle}>
                  <RouterLink to={`/chara/${df.name}`} data-ga-on="click" data-ga-event-category="chara" data-ga-event-action="statColor" data-ga-event-label={df.name}>
                    <FlatButton label={df.name} icon={df.picUrl ? <Avatar src={df.picUrl} size={30} /> : <Avatar size={30}>{df.seriesSymbol}</Avatar>} labelStyle={buttonLabelStyle} />
                  </RouterLink>
                </TableRowColumn>
